	    			...
	    			<div class="row">
	    				<div class="form-group col-md-2">
							...
							<div class="custom-panel" >
								<input id="cash_type" type="radio" name="job_sale_type" value="cash" @if($transactions->name == "job_invoice_cash" ) checked="checked" @endif  />

								<label for="cash_type" class="custom-panel-radio"><span></span>Cash</label>

								<input id="credit_type" type="radio" name="job_sale_type"  value="credit" @if($transactions->name == "job_invoice" ) checked="checked" @endif  />
								<label for="credit_type"><span></span>Credit</label>


							</div>
						</div>
						<div class="col-md-4 customer_type" style= "@if($customer_type_label == null) display:none @endif"> 
										...
										<input id="business_type" type="radio" name="customer" value="1" @if($vehicle_data->user_type == "1" ) checked="checked" @endif  />
										<label for="business_type" class="custom-panel-radio"><span></span>Business</label>
										<input id="people_type" type="radio" name="customer" value="0" @if($vehicle_data->user_type == "0" ) checked="checked" @endif  />
										<label for="people_type" ><span></span>People</label>
										<input id="anonymous_type" type="radio" name="customer" value="2"  />
										<label for="anonymous_type" ><span></span>Anonymous</label>
										</div>
									</div>
									<div class="col-md-3 search_container people " style= "@if($customer_label == null) display:none @endif">
										...
										{{ Form::select('people_id', $people,$customer_type , ['class' => 'form-control person_id', 'id' => 'person_id']) }}
									...
									<div class="col-md-3 search_container business" style= "@if($customer_label == null) display:none @endif">
										...
										{{ Form::select('people_id', $business, $customer_type, ['class' => 'form-control business_id', 'id' => 'business_id']) }}
						...
						<div class="col-md-3">
							<div class="form-group col-md-12">
								...
								{{ Form::text('customer_group', null, ['class' => 'form-control', 'id' => 'customer_group','disabled','placeholder'=>'RegularCustomer']) }}
								</div>
							</div>
						</div>
	    			</div>
	    			...
	    			<div class="row">
	    				<div class="col-md-3">
	    					<div class="form-group">	
		    					<div class="row">			
		    						<div class="col-md-10">
										...
										{{ Form::select('registration_number',$vehicles_list, $vehicles_register, ['class' => 'form-control select_item', 'id' => 'registration_number','style' => 'background-color:yellow']) }}
									</div>

									<div class="col-md-2" style="padding-top: 33px; padding-left: 3px;">
						 ...
						 <div class="col-md-3">
								<div class="row">
										...
										{{ Form::text('vehicle_name',$vehicle_data->vehicle_configuration, ['class' => 'form-control', 'id' => 'vehicle_name','disabled']) }}
									</div>
								</div>
								<div class="col-md-3">
	    					<div class="form-group col-md-12">
	    						<div class="row">
									...
									{{ Form::text('driver', $vehicle_data->driver_name, ['class'=>'form-control','id' => 'driver']) }}
								</div>
							</div>
	    				</div>
	    				<div class="col-md-3">
	    					<div class="form-group col-md-12">
	    						<div class="row">
		    					<label for="driver_number" class="control-label">Contact / Driver Number</label>
								{{ Form::text('driver_number', $vehicle_data->driver_number, ['class'=>'form-control','id' => 'driverphone']) }}
								</div>
							</div>
	    				</div>
	    			</div> 
							...
							<div class="col-md-3">
								...
								{{ Form::select('shift_name',$shifttime,null, ['class' => 'form-control ', 'id' => 'shift_name']) }}
							</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<div class="col-md-3">
							...
							<div class="form-group">
								...
								{!! Form::select('invoice_by',$employee,$transactions->employeename,['class' => 'form-control']) !!}
							</div>
						</div>
					</div>
						<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								...
								{!! Form::select('pumpname',$pumpname,null,['class' => 'form-control pumpname', 'id' => 'pumpname']) !!}
							</div>
						</div>
						<div class="col-md-3">
						...
						<div class="col-md-3">
							...
							{{ Form::select('payment_method_id', $payment, $transactions->payment_mode_id, ['class' => 'form-control select_item', 'id' => 'payment_method_id']) }} 
	    				</div>
	    				<div class="col-md-3">
							<div class="form-group">
							<div class="col-xs-12">
					...
					<div class="form-group">
						...
						<table style="border-collapse: collapse;" class="table table-bordered crud_table">
							...
							<tbody>
								...
								<td>
									{{ Form::select('item',$items,$item_id,  ['class'=>'form-control pump_item']) }}
								...
								<td >
									...
									<td>
									{{ Form::text('rate',$purchase_price,['class'=>'form-control numbers']) }} 
									
								</td>
									
									<td>{{ Form::text('discount_value', null, ['class'=>'form-control decimal']) }}</td>

								<td>
									{{ Form::text('in_stock', $in_stock, ['class'=>'form-control numbers', 'disabled', 'id' => 'in_stock']) }}
								</td>
								...
								<td>
									{{ Form::text('amount', $amount, ['class'=>'form-control numbers']) }}
								</td>
									<td>
						...
						<table id="new" class= "total_rows" align="right">
								...
								<td id="new">
									<div id="design">
										...
										<div id="right">
											{{ Form::text('sum_discount', null, ['class'=>'form-control decimal','style'=>'color:blue;font-size:15px;background-color:transparent;border:0;width:90px;padding-top:1px;','disabled']) }}  
								...
								<div class="row custom-panel-address">
									...
									<div class="col-md-12 ">
										<div class="row ">
											...
											<input type="text" class="form-control " name="billing_name" autocomplete="off" /> </div>

											<div class="col-md-3  billing">
											<label for="date">Billing Mobile</label>
											<input type="text" class="form-control  " name="billing_mobile"autocomplete="on"  /> </div>

											<div class="col-md-3  billing">
											<label for="date">Billing Email</label>
											<input type="text" class="form-control  " name="billing_email" autocomplete="off"  /> </div>
				...
				if(id != "") 
				{
					$.ajax({
						...
						success:function(data, textStatus, jqXHR) {
							...
							//console.log(data.segment_price);
							...
							if(is_group == 0){
								...
								obj.closest('tr').removeClass('items');
							} else {
							...
							obj.closest('tr').find('td > select[name=tax_id]').val(data.tax_id).prop('disabled', true);
						 ...
						 dataType: "json",
							...
							success:function(data, textStatus, jqXHR) {
								...
								var html = "";
									...
									<td>`+data.data.advance_amount+`</td> @endif
