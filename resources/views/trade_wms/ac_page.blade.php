         ...
         <div >  
                ...
                <tr>
                  ...
                  <tr>
                    <td class="align-header-td">
                      ...
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$company_info->city_name}} {{ "-" }}  {{$company_info->org_pin}}<br>
            ...
            <table class="table borderless " style="margin-left:25px;width:33%" > 
              <tr>
                ...
                <tr>
                  <td class="align-header-td" ><b>Vehicle No: </b>&nbsp;&nbsp;&nbsp;{{$customer_details->registration_no}}</td>
                </tr>
                <tr>
                ...
                <table class="table table-bordered " style="margin-left:25px;" > 
                  ...
                  @if(isset($items) && $items['service'])
                     @foreach ($items['service'] as $service)
                      ...
                      <td scope="row">{{$service->quantity}}</td>
                      </tr>
                      @endforeach
                      @endif
                  </tbody>
                            ...
                            <table class="table table-bordered ">
                              <thead>
                                <tr>
                                  ...
                                  <td align="center"><strong>JC No</strong></td>
                                </tr>
                              </thead>
                              <tbody>
