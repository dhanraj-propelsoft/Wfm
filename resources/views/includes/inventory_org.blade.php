...
@if (App\Organization::checkModuleExists('inventory', Session::get('organization_id')))
	...
	@permission('Inventory-Main-Dashboard')
	  	...
	  	<li><a class="sub-menu"><i class="fa icon-basic-folder-multiple"></i><span>Masters</span></a>
			...
			<div class="sidebar-submenu">
			  ...
			  <ul>@permission('warehouse-list')
				  <li><a data-link="warehouse" href="{{ route('warehouse.index') }}"><span>Warehouse</span></a></li>@endpermission
				  @permission('stores-list')
				  <li><a data-link="stores" href="{{ route('stores.index') }}"><span>Stores</span></a></li>@endpermission
				  @permission('rack-list')
				  <li><a data-link="rack" href="{{ route('rack.index') }}"><span>Rack</span></a></li>@endpermission
				  @permission('discount-list')
				  <li><a data-link="discount" href="{{ route('discount.index') }}"><span>Discount</span></a></li>@endpermission
				  @permission('unit-list')
				  <li><a data-link="unit" href="{{ route('unit.index') }}"><span>Units</span></a></li>@endpermission
				  @permission('shipment-mode-list')
				  <li><a data-link="shipment/mode" href="{{ route('shipment_mode.index') }}"><span>Shipment Mode</span></a></li>@endpermission
	  	...
	  	<li><a data-link="purchase_order" href="{{ route('transaction.index', ['purchase_order']) }}"><i class="fa icon-ecommerce-basket-cloud"></i><span>Purchase Order</span></a></li>@endpermission

	   	@permission('purchase-list')
	  	<li><a data-link="purchases" href="{{ route('transaction.index', ['purchases']) }}"><i class="fa icon-ecommerce-bag-check"></i><span>Purchase</span></a></li>@endpermission
	  
	 	@permission('goods-receipt-note-list')
	  	<li><a data-link="goods_receipt_note" href="{{ route('transaction.index', ['goods_receipt_note']) }}"><i class="fa icon-ecommerce-receipt"></i><span>Goods Receipt Note</span></a></li>@endpermission
	  	...
	  	<li><a data-link="internal-consumption" href="{{ route('internal_consumption.index') }}"><i class="fa icon-music-shuffle-button"></i><span>Internal Consumption</span></a></li>@endpermission
	  	...
	  	<li><a class="sub-menu"><i class="fa icon-basic-gear"></i><span>Inventory Management</span></a>
			...
			<div class="sidebar-submenu">
				<ul>
				  	...
				  	<li><a data-link="material-receipt" href="{{ route('material_receipt.index') }}"><!-- <i class="fa icon-elaboration-todolist-check"></i> --><span>Material Receipt</span></a></li>@endpermission
				   	@permission('adjustment-list')
				  	<li><a data-link="adjustment" href="{{ route('adjustment.index') }}"><!--<i class="fa icon-basic-mixer2"></i> --><span>Adjustment</span></a></li>@endpermission

				  	@permission('low-stock-report-list')
				  	<li><a data-link="low-stock-report" href="{{ route('low_stock_report.index') }}"><!-- <i class="fa icon-basic-mixer2"></i> --><span>Low Stock Report</span></a></li>@endpermission
					...
					<li><a data-link="gst-report" href="{{ route('gst_report.index','purchases') }}"><!-- <i class="fa icon-elaboration-todolist-check"></i> --><span>GST Report</span></a></li>@endpermission
