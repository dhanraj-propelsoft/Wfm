...
<div class="form-body" style="padding: 15px 25px; ">
	...
	<div class="row">
	   <div class="col-md-3 customer_type"> {{ Form::label('customer', 'Customer Type', array('class' => 'control-label required')) }} <br>
  		<input id="people_type" type="radio" name="customer" value="people" checked="checked" id="people_type" />
  		<label for="people_type"><span></span>People</label>
  		<input id="business_type" type="radio" name="customer" value="business" id="business_type" />
  		<label for="business_type"><span></span>Business</label>
  	  </div>
  	  <div class="col-md-3 search_container people"> {{ Form::label('people', $customer_label, array('class' => 'control-label required')) }}
