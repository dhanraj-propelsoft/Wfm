		...
		<div class="modal-header">
			<h4 class="modal-title float-right">End Pump Shift</h4>
		</div>
<style type="text/css">
	.control-label{
		 margin-bottom: 0;}
							...
							<div class="row cash">
								<div class="col-md-2" >
									<div class="form-group">
										...
										{!! Form::text('fuelsales', null, array('class' => 'form-control', 'id' => 'fuelsales', )) !!}
									</div>
								</div>
								<div class="col-md-2" >
									<div class="form-group">
										...
										{!! Form::text('othersales',null,array('class' => 'form-control', 'id' => 'othersales')) !!}
									</div>
								</div>
								<div class="col-md-2" >
									<div class="form-group">
										...
										{!! Form::text('otherreceipt',null,array('class' => 'form-control', 'id' => 'otherreceipt' )) !!}
									</div>
								</div>
								<div class="col-md-2" >
									<div class="form-group">
										...
										{!! Form::text('expenses',null,array('class' => 'form-control', 'id' => 'expenses')) !!}
									</div>
								</div>
								<div class="col-md-2" >
									<div class="form-group">
								...
								<tbody>									 
									...
									<tr class="parent_items">
										<td class="pump">{{$pump->pumpsname}}
											{!! Form::hidden('pumpid[]',$pump->pumpid,null,['class' => 'form-control']) !!}
												
											{!! Form::hidden('fsm_id[]',$pump->fsm_id,null,['class' => 'form-control']) !!}
										</td>	
										<td>{{$pump->productname}}
										...
										<td class="openmeter_td">
											{!! Form::text('open_meter[]',null,['class' => 'form-control open_meter','id' => 'open_meter']) !!}
										</td>
										<td class="closemeter_td">
											{!! Form::text('close_meter[]',null,['class' => 'form-control close_meter','id' => 'close_meter']) !!}
										</td>
										<td class="testing_td">
											{!! Form::text('testing[]',null,['class' => 'form-control testing','id' => 'testing']) !!}
										</td>
										<td class="quantity_td" id="quantity_td">
											{!! Form::text('quantity[]',null,['class' => 'form-control quantity','id' => 'quantity','disabled']) !!}
										</td>
										<td class="salesbycash_td">
											{!! Form::text('salesby_cash[]',null,['class' => 'form-control salesbycash','id'=>'salesby_cash','disabled']) !!}
										</td>
										<td >
											{!! Form::text('attendant[]',null,['class' => 'form-control attendant','id'=>'attendant']) !!}
										</td>
										<td  class="salequantity_td">
											{!! Form::text('sale_quantity[]',null,['class' => 'form-control sale_quantity','id'=>'sale_quantity']) !!}
										</td>
										<td class="sale_cash_td">
											{!! Form::text('sale_cash[]',null,['class' => 'form-control sale_cash','id'=>'sale_cash']) !!}
										</td>
										<td class="result_td">
											{!! Form::text('more_less[]',null,['class' => 'form-control more_less','disabled','id'=>'more_less']) !!}
										</td>
										<td>
									...
									<tr>
										...
										<td class="totalquantity_td">{!! Form::text('totalquantity[]',null,['class' => 'form-control totalquantity','id' => 'totalquantity','disabled']) !!}</td>
										<td>{!! Form::text('totalcash[]',null,['class' => 'form-control totalcash','id' => 'totalcash','disabled']) !!}</td>
										<td>Total by Manual</td>
										<td>{!! Form::text('salequantity[]',null,['class' => 'form-control salequantity_total','id' => 'salequantity','disabled']) !!}</td>
										<td>{!! Form::text('salecash[]',null,['class' => 'form-control salecash_total','id' => 'salecash','disabled']) !!}</td>
										<td>{!! Form::text('moreless[]',null,['class' => 'form-control moreless_total','id' => 'moreless','disabled']) !!}</td>
										<td></td>
	       ...
	       format: 'dd.mm.yyyy'
			...
			function submit1(){
                ...
                var invoice=invoice_no.join(",")
             	...
             	$(function() 
             	{
		   			 $(".open_meter, .close_meter,.testing,.sale_quantity,.sale_cash,.more_less").on("keydown keyup  ",calculate);
		   			 function calculate()
		   			 {
             	...
             	$(function() 
             	{
					...
					$('.moreless_total').val(descrepancy_total);
				}
	...
	basic_functions();	
		...
		messages: {
				...
				submitHandler: function(form) {
					...
					var pumpid= [];
					$('input:hidden[name="pumpid[]"]').each(function()
					{
						pumpid.push($(this).val());
					});
