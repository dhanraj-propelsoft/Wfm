<div>
	...
	<div class="row">
		<a href="{{ route('contact.index', ['customer']) }}">
        ...
        <a href="{{ route('transaction.index', ['sales']) }}">
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="dashboard-stat" style="background: #3498db;">
					...
					<div class="details">
						<div class="number"> 
							...
							<span data-counter="counterup" data-value="12,5">{{number_format($total_sales, 2)}}
                            </span>
                        </div>
        ...
        <a href="{{ route('cash_transaction.index', ['receipt']) }}">
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        ...
        <a href="{{ route('transaction.index', ['sale_order']) }}">
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
