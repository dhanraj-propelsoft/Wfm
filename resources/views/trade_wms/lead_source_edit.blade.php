<div class="modal-header">
    <h4 class="modal-title float-right">Edit Lead Source</h4>
</div>

    {!!Form::model($lead_source, ['class' => 'form-horizontal validateform'])!!}
    {{ csrf_field() }}
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                ...
                success:function(data, textStatus, jqXHR) {
                    ...
                    <td>
                        <input id="`+data.data.id+`" class="item_check" name="leadsource" value="`+data.data.id+`" type="checkbox">
