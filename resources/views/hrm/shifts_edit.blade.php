<div class="modal-header">
    <h4 class="modal-title float-right">Edit Shift</h4>
</div>

    {!!Form::model($work_shift, [
...
<div class="modal-body">
	<div class="form-body">
		...
		<div class="form-group">
			...
			<div class="col-md-12">
				@foreach($work_breaks as $work)											
					<input type="checkbox" name="break_id" id="{{ $work->break_id }}" <?php if(in_array($work->break_id, $shift_breaks)) { echo 'checked="checked"'; } ?> value="{{ $work->break_id }}">
	...
	$('.validateform').validate({
        ...
        submitHandler: function(form) {
            ...
            success:function(data, textStatus, jqXHR) {
            	...
            	if((data.data.break_id).length > 0) {
            		var breaks = data.data.break_id;
            		for(i in breaks) {
