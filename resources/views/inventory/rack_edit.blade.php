<div class="modal-header" style="background-color: #e9ecef;">
	...
	<h5 class="modal-title float-right"><b>Edit Rack</b></h5>
...
<div class="modal-body" style="overflow-y: scroll;">
  ...
  <div class="form-body">
	...
	<div class="form-group">		
		...
		<input name="check_store" type="checkbox" id="check_store"

				@if($racks->store_id != null) checked="checked" @endif />
	...
	<div class="form-group store"  @if($racks->store_id == null)style="display:none;" @endif>
	...
	<div class="form-group warehouse"  @if($racks->store_id != null)style="display:none;" @endif>
