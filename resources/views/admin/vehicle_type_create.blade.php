<div class="modal-header">
	<h4 class="modal-title float-right">Add Vehicle Type</h4>
</div>
...
<div class="modal-body">
	<div class="form-body">
		<div class="form-group">
			{!! Form::label('name', 'Type Name', array('class' => 'control-label col-md-4 required')) !!}
...
<script>
	$('.validateform').validate({
		...
		messages: {
			...
			name: { required: "Type Name is required.", remote: "Type Name is already exists!" },                
		},
