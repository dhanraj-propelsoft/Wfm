...
class CreateAttachmentsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::connection('mysql2')->create('attachments', function($table){
            
        $table->increments('id');
        $table->integer('attach_id')->unsigned()->nullable()->comment('1-Project,2-Task');
        $table->string('attach_type')->nullable()->comment('if project means project_id and task means task_id');
