...
<div class="content">
	<div class="fill header">
		<h3 class="float-left">Job Invoice</h3>
			            ...
			            <div class="form-group col-md-12">
		  	          	...
		  	          	<div class="form-group col-md-12">
			          		<div class="row">
				                ...
				                <div class="col-md-6">
					                <label for="assigneed_to">Invoice By</label>
					                {{ Form::select('invoice_by', [], null, ['class' => 'form-control', 'id' => 'assigneed_to']) }}
				              	</div>
		  	            	</div>
		  	            </div>
		  	            <div class="form-group col-md-12">
				          	<div class="row">
				                <div class="col-md-6">
				                	{{ Form::label('invoice_date', 'Invoice Date', array('class' => 'control-label required')) }}
					               	{{ Form::text('invoice_date', null, ['class' => 'form-control', 'id' => 'assigneed_to']) }}
				              	</div>
				              	<div class="col-md-6">
				              		{{ Form::label('payment_due_date', 'Payment Due Date', array('class' => 'control-label required')) }}
					                {{ Form::text('payment_due_date', null, ['class' => 'form-control', 'id' => 'assigneed_to']) }}
				              	</div>
				            </div>
				        </div>
				        <div class="form-group col-md-12">
							<div class="row">
				                <div class="col-md-6">
				              	...
				              	<div class="col-md-6">
									...
									{{ Form::select('payment_method',[], null, ['class'=>'form-control ']) }}
				             	</div>
				            </div>
				        </div>
				        <div class="form-group col-md-12">
							<div class="row">
				                <div class="col-md-6">
				              	...
				              	<div class="col-md-6">
					                <label for="delivery_on">Delivery On</label>
									{{ Form::text('delivery_on', date('d-m-Y'), ['class'=>'form-control date-picker datetype', 'data-date-format' => 'dd-mm-yyyy', 'autocomplete' => 'off']) }}
				             	</div>
				            </div>
				        </div>
