	...
	<div class="row">
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="dashboard-stat" style="background: #5483b6;">
					...
					<div class="details">
						<div class="number"> +
							<span data-counter="counterup" data-value="12,5">{{$new_orders}} </span> <i style="font-size: 28px;" class="fa fa-inr"></i>  </div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		if ($(window).width() < 1000) {
		   $('#consumers, #sales').css('width', '300px');
		}else if ($(window).width() < 1300) {
           $('#consumers, #sales').css('width', '430px');
        }else if ($(window).width() < 1400) {
           $('#consumers, #sales').css('width', '480px');
        }
