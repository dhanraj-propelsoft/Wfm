...
class CreateMaterialReceiptsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('material_receipts', function (Blueprint $table) {
            ...
            $table->integer('user_type', false);
            $table->integer('people_id', false)->unsigned();
            ...
            $table->integer('work_id', false)->unsigned()->nullable();
            $table->integer('warehouse_id', false)->unsigned()->nullable();
            $table->text('description')->nullable();
            $table->integer('is_party', false)->default(0);
            ...
            $table->foreign('work_id')->references('id')->on('inventory_items')
                ->onUpdate('cascade');
