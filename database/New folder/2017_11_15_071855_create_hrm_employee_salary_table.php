...
class CreateHrmEmployeeSalaryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hrm_employee_salary', function (Blueprint $table) {
            $table->increments('id');
            $table->decimal('ot_wage', 10, 2)->nullable();
    ...
    {
        Schema::dropIfExists('hrm_employee_salary');
    }
}
