<div class="modal-header">
	<h4 class="modal-title float-right">Add  item type</h4>
</div>
	...
	<div class="form-body">
		<div class="row">
			 	...
			 	<div class="col-md-12">
					...
					{!! Form::select('categoryname',$itemtype,null,['class' => 'form-control select_item']) !!}
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
			{!! Form::label('item', 'Add  itemtype', array('class' => 'control-label  required','id'=>'itemtype')) !!}
