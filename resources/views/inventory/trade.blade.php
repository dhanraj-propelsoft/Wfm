...
@if (App\Organization::checkModuleExists('trade', Session::get('organization_id')))
	  ...
	  <li><a data-link="delivery_note" href="{{ route('transaction.index', ['delivery_note']) }}"><i class="fa icon-basic-todo-pen"></i><span>Delivery Challan</span></a></li>
	  <li><a data-link="credit_note" href="{{ route('transaction.index', ['credit_note']) }}"><i class="fa icon-ecommerce-bag-upload"></i><span>Sale Return</span></a></li>
	  ...
	  <li><a data-link="gst-trade" href="{{ route('gst_trade.index') }}"><!-- <i class="fa icon-elaboration-todolist-check"></i> --><span>GST Report</span></a></li>
@endif
@endif
@stop
