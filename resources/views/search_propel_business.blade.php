...
<br><br><br><br>
  <h5>Please enter your propel id to continue your registration</h5>
	...
	{!! Form::open([
	  'route' => 'register_propel_business_id',
	  'class' => 'horizontal-form propelform',
	  'id' => 'searchform'
	  ]) !!}
{{ csrf_field() }}
	  <div class="form-group">
		<input name="business_id" type="text" class="form-control" placeholder="Propel Business-Id" />
	  </div>
...
$('.propelform').validate({
			...
			messages: {
				business_id: {
					required: "Propel Business-Id is required.",
					remote: "Propel Business-Id does not exist!"
				}
			},
