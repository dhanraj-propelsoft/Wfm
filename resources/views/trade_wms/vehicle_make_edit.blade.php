<div class="modal-header">
	<h4 class="modal-title float-right">Edit Vehicle Makers</h4>
</div>

	{!!Form::model($vehicle_make, [
...
<div class="modal-body">
	<div class="form-body">
		...
		<div class="form-group">
			{!! Form::label('name', 'Vehicle Makers Name', array('class' => 'control-label col-md-5 required')) !!}
