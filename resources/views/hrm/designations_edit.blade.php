<div class="modal-header">
	<h4 class="modal-title float-right">Edit Designation</h4>
</div>
...
<div class="modal-body">
  <div class="form-body">
	...
	<div class="form-group">
	  {!! Form::label('name', 'Designation Name', array('class' => 'control-label col-md-4 required')) !!}
	...
	<div class="form-group">
	  {!! Form::label('department_id', 'Department', array('class' => 'control-label col-md-3')) !!}

	  <div class="col-md-12">
		{{Form::select('department_id', $department, null, ['class'=>'form-control select_item'])}}
	  </div>
	</div>    
	<div class="form-group">             
	...
	<div class="form-group">
	  {!! Form::label('positions', 'Total Positions', array('class' => 'control-label col-md-4')) !!}

	  <div class="col-md-12">
		{!! Form::text('positions', null,['class' => 'form-control numbers']) !!}
	  </div>
	</div>
  </div>
</div>
		...
		submitHandler: function(form) {
			...
			$.ajax({
			 ...
			 data: {
				...
				positions: $('input[name=positions]').val(),
				},
