...
<div class="modal-header">
	<h4 class="modal-title float-right">Edit Daily Dip Reading</h4>
</div>
	...
	<div class="form-body">
		<div class="row">
			<div class="form-group col-md-12"> 
				...
				{!! Form::select('tankname',$tankname, $reading->tank_id,['class' => 'form-control' ,'id'=>'tank_id']) !!}
			</div>
		</div>
		<div class="row">
			<div class="form-group col-md-12"> 
				...
				{!! Form::select('product',$product, $reading->product_id,['class' => 'form-control']) !!}
			</div>
		</div>
		<div class="row">
	    	<div class="form-group col-md-8">
				<label class="control-label required" for="order_id">Reading Type</label> <br>
					<div class="custom-panel" >
						...
						<input id="open" type="checkbox" name="reading_type" value="1" @if($reading->reading_type == 1 ) checked="checked" @endif  >
						<label for="open" class="custom-panel-radio"><span></span>Open</label>

						<input id="close" type="checkbox" name="reading_type"  value="2" @if($reading->reading_type == 2 ) checked="checked" @endif >
						<label for="close" class="custom-panel-radio" ><span></span>Close</label>

						<input id="on_demand" type="checkbox" name="reading_type"  value="3" @if($reading->reading_type ==3 ) checked="checked" @endif >
		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-group">
					...
					{!! Form::text('dip_reading', $reading->dip_reading,['class' => 'form-control','id'=>'dipreading']) !!}
				</div>
			</div>
		</div>	
		<div class="row">
			<div class="col-md-12">
				<div class="form-group">
					...
					{!! Form::text('temparature', $reading->temparature,['class' => 'form-control']) !!}
				</div>
			</div>
		</div>	
		<div class="row">
			<div class="col-md-12">
				<div class="form-group">
					...
					{!! Form::text('quantity', $reading->quantity,['class' => 'form-control','id'=>'quantity','disabled']) !!}
					{!! Form::hidden('id', $reading->id,['class' => 'form-control','id'=>'id','disabled']) !!}
				</div>
			</div>
		</div>	
		<div class="row">
			<div class="form-group col-md-12"> 
				...
				{!! Form::select('reading_by',$reading_by, $reading->reading_by,['class' => 'form-control']) !!}
			</div>
		</div>
		...
		submitHandler: function(form) {
			...
			success:function(data, textStatus, jqXHR) {
				...
				call_back(`<tr role="row" class="odd">
				    ...
				    <td><label class="grid_label badge `+type_class+` ">`+type_text+`</label>
						</td>
					<td>
