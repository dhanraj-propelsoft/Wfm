<div class="modal-header">
	<h4 class="modal-title float-right">Edit  Make Item</h4>
</div>
...
<div class="modal-body">
	<div class="form-body">
			...
			{!! Form::label('makename', 'Edit make items', array('class' => 'control-label  required','id'=>'make')) !!}
{!! Form::hidden('makeid', $itemmake->id ) !!}
				<div class="form-group">
				{!! Form::text('makename',$itemmake->name,['class' => 'form-control']) !!}
			</div></div>
		</div>
...
<script>
	...
	$('.validateform').validate({
		...
		messages: {
			...
			makename: { required: " category name is required.",
	...
	// 	},
		...
		submitHandler: function(form) {
			...
			data: {
				_token: '{{ csrf_token() }}',
				 makeid: $('input[name=makeid]').val(),
				makename: $('input[name=makename]').val(),
