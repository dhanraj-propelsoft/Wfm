<div class="modal-header">
    <h4 class="modal-title float-right">Edit Project Category</h4>
</div>

{!! Form::model($Project, ['class' => 'form-horizontal validateform']) !!}
{{ csrf_field() }}
        ...
        <div class="form-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    {!! Form::label('name', 'Project category name', ['class' => ' control-label required']) !!}
                
                    {!! Form::text('project_category_name', null, array('class' => 'form-control')) !!}
                    </div>
                </div>
            </div>
