...
<div class="modal-header">
  <h4 class="modal-title float-right">Add Item Group</h4>
</div>
  		...
  		<div class="form-body">
					...
					<div class="form-group col-md-8">
							...
							<div class="row">
								<div class="form-group col-md-12">
									{{ Form::label('invenoty_type', 'Inventory Type', array('class' => 'control-label col-md-12 required')) }}
							  
									<div class="col-md-12">
										<div class="row">
									
										<div class="col-md-4">
											{{ Form::radio('type','1', true, ['class' => 'md-radiobtn', 'id'=> 'goods']) }}
											<label for="goods"><span></span>Goods</label>
										</div>
										<div class="col-md-4">
											{{ Form::radio('type', '2', null, array('id' => 'service')) }}
								...
								<div class="form-group col-md-12">
									...
									<div class="col-md-12">
									{!! Form::text('name', null, ['class'=>'form-control', 'placeholder'=>'Name','id'=>'name']) !!}</div>
								</div>
							...
							<div class="row">
								<div class="form-group col-md-4">
							  	<div class="col-md-12"> 
							  		{{ Form::radio('grouping','1', true, ['class' => 'md-radiobtn', 'id'=> 'group_price']) }}
								<label for="group_price"><span></span>Group Price</label>
							  	</div>
								</div>
								<div class="form-group col-md-4">
								  	<div class="col-md-12"> 
								  		{{ Form::radio('grouping', '0', null, array('id' => 'individual_price')) }}
							...
							<!-- <div class="row" >
								<div class="form-group col-md-12">
									{{ Form::label('category_id', 'Category', array('class' => 'control-label col-md-5 required')) }}

									<div class="col-md-12">
									{!! Form::select('category_id', ['' => 'Select Category'], null, ['class' => 'select_item form-control', 'id' => 'category_id']) !!}
				...
				<div class="form-group">
				  	<table class="table">
						...
						<tbody>
						  	<tr>
								<td>
									{!! Form::select('item_id', $inventory_items, null, ['class' => 'select_item form-control', 'id' => 'item_id']) !!}
								</td>
								<td>
								...
								<td class="quantity">
									{!! Form::text('quantity', null, ['class'=>'form-control numbers', 'placeholder'=>'Item Quantity','id'=>'quantity']) !!}
								</td>
								
								<td>
									<select name='item_tax_id' class='form-control select_item taxes' id = 'item_tax_id'>
								...
								<td>
									<a class="grid_label action-btn delete-icon remove_row" style="display: none;"><i class="fa fa-trash-o"></i></a> <a class="grid_label action-btn edit-icon add_row"><i class="fa fa-plus"></i></a>
								</td>
						  	</tr>
						</tbody>
				  </table>
				...
				<div class="row">
					  <div class="form-group col-md-6"> 
					  	{{ Form::label('hsn', 'HSN', array('class' => 'control-label col-md-5')) }}
							<div class="col-md-12"> 
				...
				<div class="row" class ="include_tax">
					<div class="form-group col-md-4">
				...
				<div class="row">
					  ...
					  <div class="form-group col-md-3 list_price"> 
						...
						<div class="col-md-12"> {!! Form::text('list_price', null, ['class'=>'form-control numbers', 'placeholder'=>'List Price','id'=>'list_price']) !!} </div>
					  </div>


					  <div class="form-group col-md-3 discount"> 
					  ...
					  <div class="col-md-12">{!! Form::text('sale_price', null, ['class'=>'form-control', 'placeholder'=>'Sale Price','id'=>'sale_price']) !!}
					  </div>
					  </div>
				</div>
				...
				<div class="row">
				  	...
				  	<div class="col-md-12">                     
				  	{!! Form::text('on_date',null,['class' => 'form-control date-picker', 'data-date-format' => 'dd-mm-yyyy', 'id'=>'on_date']) !!}
				  	</div>
				  	</div>
				...
				<!-- <div class="form-group purchase">
					<div class="row">
						<div class="form-group col-md-4"> 
						  ...
						  <div class="col-md-12">{!! Form::text('initial_quantity', null, ['class'=>'form-control numbers', 'placeholder'=>'Quantity','id'=>'low_stock']) !!}
						  </div>
...
$(document).ready(function() {
	...
	@include('modals.add_gst')
		...
		$('body').off('click', '.add_row').on('click', '.add_row', function() {
			...
			clone.find('select[name=item_id], input[name=quantity], input[name=price], select[name=item_tax_id]').val("");
				...
				$.ajax({
				  url: "{{ route('get_categories_group') }}",
					...
					success:function(data, textStatus, jqXHR) {
						  ...
						  //$('input[name=category_id]').val(result);
						...
						call_back(`<tr>
					  	<td>
							...
							<label for="`+data.data.id+`"><span></span></label>
								...
								<td><img style="border:2px solid #ccc; border-radius: 3px;" src="" width="50" height="50">`+data.data.name+result+`</td>
