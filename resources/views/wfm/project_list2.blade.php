...
$('input[name="attachment"]').on('change', function(e) {
  ...
  if(e.target.files && e.target.files.length > 0) {
    ...
    reader.onload = function () {
      ...
      createInput("hidden","attachment_multiple_mime[]","attachment_mime_"+id,"attachment_mime",fileType,element);
      createInput("hidden","attachment_multiple_ext[]","attachment_type_"+id,"attachment_type",fileExtension,element);
      createInput("hidden","attachment_multiple[]","attachment_"+id,"attachment",input_value,element);
      $("#attachment_datalist").append('<li class="tagit-choice ui-widget-content ui-state-default ui-corner-all tagit-choice-editable"><span class="tagit-label">'+fileName+'</span><a class="tagit-close"><span class="text-icon" onclick="removeAttachment(this)" data-id="attachment_'+id+'" data-type-id="attachment_type_'+id+'" data-mime-id="attachment_mime_'+id+'">×</span><span class="ui-icon ui-icon-close"></span></a></li>');
