...
<div class="modal-header">
    ...
    <div class="ui-select pull-left">
        <div data-corners="true" data-shadow="true" data-iconshadow="true" data-wrapperels="span" data-icon="arrow-d"
             ...
             class="ui-btn ui-shadow ui-btn-corner-all ui-btn-icon-right ui-btn-up-c"></div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('project_name', $data->pName, array('class' => 'inputText','id'=>'project_name','style'=>' border: 1px solid #ced4da;color: #999;')) !!}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('project_details', $data->pDetails, array('class' => 'inputTextArea','rows'=>4,'style'=>' border: 1px solid #ced4da;color: #999;','id'=>'project_details')) !!}
                        <span class="fa fa-plus-circle floating-label"
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-md-6 form-group">
                    <div class="input-group " style="border: 1px solid #ddd;" data-toggle='tooltip'
                      ...
                      {!! Form::select('pEmployeeDatas',$data->pEmployeeDatas,$data->pProjectOwner,['class' =>'form-control select_item']) !!}
