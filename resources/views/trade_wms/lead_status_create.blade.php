<div class="modal-header">
    <h4 class="modal-title float-right">Add Lead Status</h4>
</div>
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                ...
                call_back(`<tr role="row" class="odd">
                    <td>
                        <input id="`+data.data.id+`" class="item_check" name="leadstatus" value="`+data.data.id+`" type="checkbox">
