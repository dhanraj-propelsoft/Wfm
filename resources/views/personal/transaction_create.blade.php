<div class="modal-header">
    <h4 class="modal-title float-right">Add Transaction </h4>
</div>
	...
	<div class="form-body">
		...
		<div class="col-md-7">
			...
			<div class="col-md-12 form-group" style="margin-bottom: 0px;">
				{!! Form::hidden('transaction_type', null, ['class' => 'form-control']) !!}
				{{Form::select('transaction_category', ["" => "Select Category"], null, ['class'=>'form-control select_item'])}}
			</div>
		</div>	
		<div class="col-md-5">
			...
			<div class="col-md-12">
				{!! Form::text('amount', null, ['class' => 'form-control price']) !!}
			</div>
		</div>
		</div>
		</div>
		...
		<div class="col-md-4">
			...
			<div class="col-md-12">
				{!! Form::text('date', date('d-m-Y'), ['class' => 'form-control  date-picker datetype', 'data-date-format' => 'dd-mm-yyyy', 'autocomplete' => 'off']) !!}
			</div>
		</div>
		<div class="col-md-4">
			{!! Form::label('account_id', 'From Account', array('class' => 'control-label col-md-12 account required')) !!}
...
$(document).ready(function() {
	...
	$('.validateform').validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
            url: '{{ route('personal_transaction.store') }}',
            type: 'post',
            data: {
                _token: '{{ csrf_token() }}',
