		...
		<div class="row">
			<div class="form-group col-md-12"> 
							...
							<div class="form-group">
								...
								{!! Form::select('tank_name',$tank,null,['class' => 'form-control tank_name', 'id' => 'tank_name']) !!}
		...
		<div class="row">
			<div class="form-group col-md-6"> 
							...
							<div class="form-group">
								...
								{!! Form::text('opening',null,['class' => 'form-control opening', 'id' => 'opening']) !!}
							</div>
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					{{ Form::text('purchase',  null, ['class' => 'form-control purchase ', 'id' => 'purchase']) }} 
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					{{ Form::text('sales',  null, ['class' => 'form-control sales ', 'id' => 'sales']) }} 
			...
			<div class="form-group col-md-6"> 
				<div class="form-group">
					...
					{!! Form::text('total_stock',null,['class' => 'form-control total_stock', 'id' => 'total_stock','disabled']) !!}
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					{!! Form::text('closing', null,['class' => 'form-control closing','id' => 'closing','disabled']) !!}
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-4">
				<div class="form-group">
					...
					{!! Form::text('unit_rate', null,['class' => 'form-control unit_rate ','id' => 'unit_rate','disabled']) !!}
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
					{!! Form::label('sales_worth', 'SalesWorth', array('class' => 'control-label  ')) !!}
					{!! Form::text('sales_worth', null,['class' => 'form-control sales_worth','id' => 'sales_worth','disabled']) !!}
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
					{!! Form::label('stock_worth', 'StockWorth', array('class' => 'control-label  ')) !!}
					{!! Form::text('stock_worth', null,['class' => 'form-control stock_worth','id' => 'stock_worth','disabled']) !!}
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-md-4">
				<div class="form-group">
					...
					{!! Form::hidden('product', null,['class' => 'form-control product','id'=>'product']) !!}
				</div>
			</div>
		</div>
        ...
        $.ajax({
           ...
           success:function(res){               
            if(res){
                ...
                $("#unit_rate").val(res.unit_rate);
                $("#sales_worth").val(res.sales_worth);
                $("#stock_worth").val(res.stock_worth);
