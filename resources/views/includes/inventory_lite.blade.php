	  	...
	  	<!-- <li><a class="sub-menu"><i class="fa icon-basic-gear"></i><span>Inventory Management</span></a>
			...
			<div class="sidebar-submenu">
				...
				<ul>
				  	...
				  	<li><a data-link="material-receipt" href="{{ route('material_receipt.index') }}"><span>Material Receipt</span></a></li>@endpermission

				   	@permission('adjustment-list')
				  	<li><a data-link="adjustment" href="{{ route('adjustment.index') }}"><span>Adjustment</span></a></li>@endpermission

				  	@permission('low-stock-report-list')
				  	<li><a data-link="low-stock-report" href="{{ route('low_stock_report.index') }}"><span>Low Stock Report</span></a></li>@endpermission
					...
					<li><a data-link="gst-report" href="{{ route('gst_report.index','purchases') }}"><span>GST Report</span></a></li>@endpermission

					<li><a data-link="receipts_report" href="{{ route('receipts_report') }}"><span>Receivables Report</span></a></li>
