...
use App\Http\Controllers\Tradewms\Estimation\EstimationService;
...
class EstimationController extends Controller
{
     ...
     */
    public function __construct(EstimationService $serv)
    {
        $this->serv = $serv;
    }
    ...
    {
        Log::info('EstimationController->index:-Inside ');
        $entities = $this->serv->findAll($id,$request);
        Log::info('EstimationController->index:- Return ');
        return $entities;
    }
    ...
    public function estimation_from_jobcard($id)
    {
        //dd($id);
        Log::info('EstimationController->estimation_copy_from_jobcard:-Inside ');
        $entities = $this->serv->estimation_from_jobcard($id);
		Log::info('EstimationController->estimation_copy_from_jobcard:- Return ');
		return $entities;
    }
}
