<div class="modal-header">
	<h4 class="modal-title float-right">Edit Vehicle Tyre Type</h4>
</div>

	{!!Form::model($tyre_type, [
...
<div class="modal-body">
	<div class="form-body">
		...
		<div class="form-group">
			{!! Form::label('name', 'Tyre Type', array('class' => 'control-label col-md-4 required')) !!}
...
<script>
	$('.validateform').validate({
		...
		messages: {
			...
			name: { required: "Tyre Type is required.", remote: "Tyre Type is already exists!" },                
		},
