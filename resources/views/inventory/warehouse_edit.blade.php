<div class="modal-header" style="background-color: #e9ecef;">
	...
	<h5 class="modal-title float-right"><b>Edit Warehouse</b></h5>
...
{!! Form::model($warehouse,['class' => 'form-horizontal validateform']) !!}
	...
	<div class="form-body">
		...
		<div class="row">
			...
			<div class="col-md-6 search_container"> 
				...
				{{ Form::select('employee_id', $employees, $selected_employee, ['class' => 'form-control', 'id' => 'employee_id']) }}
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				{!! Form::select('state', $state, $selected_state, ['class' => 'select_item form-control']); !!}
			...
			<div class="col-md-6">
				...
				{!! Form::select('city', $city, $warehouse->city_id, ['class' => 'select_item form-control']); !!}
