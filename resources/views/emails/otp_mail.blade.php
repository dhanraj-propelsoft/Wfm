                    ...
                    <tr>
                      ...
                      <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
                       ...
                       <center><img src="{{ $message->embed(public_path().'/logo.png') }}" width="198" ></center> 
                        ...
                        <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px; color: #4d4d4f;">Welcome, We thank you for choosing PropelSoft</p>



                       

                        <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px; color: #4d4d4f;">Your OTP Code is: {{$otp}}</p>
