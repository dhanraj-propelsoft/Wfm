	  	...
	  	<li><a class="sub-menu" data-toggle="tooltip" data-placement="top" title=" Propel Management"><i class="fa icon-basic-folder-multiple"></i><span> Propel Management </span></a>
			...
			<div class="sidebar-submenu">
			  	<ul>
			  	    ...
			  	    <li><a data-link="today_summary" data-toggle="tooltip" data-placement="top" title="Today Summary" href="{{ route('trade_wms.today_summary') }}"><span>Today Summary</span></a></li>
