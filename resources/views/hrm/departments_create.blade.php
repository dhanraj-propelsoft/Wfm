...
<div class="modal-body">
	<div class="form-body">
		...
		<div class="form-group">
			<div class="col-md-12">
				{{ Form::checkbox('parent_name', '1', null, array('id' => 'sub_department')) }} 
				<label for="sub_department"><span></span>Is sub-department</label>
			</div>
		</div>	
		<div class="form-group parentname">
			{!! Form::label('parent_department', 'Parent Department', array('class' => 'control-label col-md-4')) !!}

			<div class="col-md-12">
				{{Form::select('parent_department', $parent_dept, null, ['class'=>'form-control select_item parentname'])}}
			</div>
		</div>		
		<div class="form-group">						 
...
<script>
	$(document).ready(function() {
		...
		$('input[name="parent_name"]').on('change', function() {
	...
	$('.validateform').validate({
		...
		submitHandler: function(form) {
			...
			$.ajax({
			url: '{{ route('hrm_departments.store') }}',
			type: 'post',
			data: {
				_token: '{{ csrf_token() }}',
