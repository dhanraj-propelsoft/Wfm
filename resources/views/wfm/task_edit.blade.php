<div class="modal-header">
    <h4 class="modal-title float-right">Edit Task status</h4>
</div>

{!! Form::model($task, ['class' => 'form-horizontal validateform']) !!}
{{ csrf_field() }}
        ...
        <div class="form-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    {!! Form::text('task_status_name', null, array('class' => 'form-control')) !!}
                    </div>
                </div>
            </div>
