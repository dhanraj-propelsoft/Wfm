<div class="modal-header">
	<h4 class="modal-title float-right">Edit No of Wheels</h4>
</div>

	{!!Form::model($vehicle_wheel, [
...
<div class="modal-body">
	<div class="form-body">
		...
		<div class="form-group">
			{!! Form::label('name', 'No of Wheels', array('class' => 'control-label col-md-4 required')) !!}
...
<script>
	$('.validateform').validate({
		...
		messages: {
			...
			name: { required: "No of Wheels is required.", remote: "This No of Wheels is already exists!" },                
		},
		...
		submitHandler: function(form) {
			...
			$.ajax({
			url: '{{ route('vehicle_wheels.update') }}',
			type: 'post',
			data: {
				_token: '{{ csrf_token() }}',
				_method: 'PATCH',
