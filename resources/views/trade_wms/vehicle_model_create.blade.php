<div class="modal-header">
	<h4 class="modal-title float-right">Add Vehicle Model</h4>
</div>
...
<div class="modal-body">
	<div class="form-body">
		...
		<div class="form-group">
			...
			<div class="col-md-12">
				{{Form::select('make_id', $vehicle_make_id, null, ['class'=>'form-control select_item'])}}
			</div>
		</div>		
		<div class="form-group">						 
