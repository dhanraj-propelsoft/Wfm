...
@if (App\Organization::checkModuleExists('hrm', Session::get('organization_id')))
	  ...
	  @permission('attendance-list')
	  	<li><a href="{{ route('hrm_attendance.index') }}"><i class="fa icon-basic-calendar"></i><span>Attendance</span></a></li>
	  @endpermission
	  ...
	  @permission('leaves-list')
	  	<li><a data-link="leaves" href="{{ route('leaves.index') }}"><i class="fa icon-arrows-exclamation"></i><span>Leave Request</span></a></li>
	  @endpermission
	  @permission('permissions-list')
	  	<li><a data-link="permissions" href="{{ route('permissions.index') }}"><i class="fa icon-basic-clessidre"></i><span>Permission Request</span></a></li>
	  @endpermission
