...
<div class="content">
	  ...
	  <table class="table crud_table">
		...
		<tbody>
		  <tr>
			...
			<td>{{ Form::textarea('description', null, ['class' => 'form-control', 'style' => 'height:29px;','placeholder' => 'Enter the Description']) }}</td>
  ...
  <div class="save_btn_container">
  	...
  	<button type="submit" @if($entry->reference_voucher_id || $entry->entry_id) style="display:none;" @endif class="btn btn-success">Save & Close</button>
