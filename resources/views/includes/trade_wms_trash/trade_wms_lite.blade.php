	...
	@if($plan_name =='Lite')
			...
			<div class="sidebar-submenu">
			  	<ul>
				    ...
				    <li ><a class="sub-menu" data-toggle="tooltip" data-placement="top" title="Vehicle Masters"><span> Vehicle Masters</span></a>
		  			...
		  			<li><a data-link="master_specification" data-toggle="tooltip" data-placement="top" title="Vehicle Specifications " href="{{ route('specification_master.index') }}"><span> Specification Master</span></a></li>
		  			@endpermission 

		  			 @permission('vehicle-specifications')
		  			<li><a data-link="vehicle/specification" data-toggle="tooltip" data-placement="top" title="Masters" href="{{ route('specification.index') }}"><span> Vehicle Specifications </span></a></li>
		  			@endpermission 
		...
		<li class="header"><span> Pricing-Master </span></li>
		@permission('wms-customer-info-list')
		  <li><a data-link="contact" hdata-toggle="tooltip" data-placement="top" title="Customer" ref="{{ route('contact.index', ['wms-customer']) }}"><i class="fa fa-user"></i><span>Customer</span></a></li>
		@endpermission
		<!-- @permission('customer-grouping')
		  <li><a data-link="customer_grouping" href="{{ route('customer_grouping.index') }}"><i class="fa fa-user"></i><span>Customer Grouping </span></a></li>
		@endpermission -->
