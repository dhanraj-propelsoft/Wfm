<div class="modal-header" style="background-color: #e9ecef;">
	...
	<h5 class="modal-title float-right"><b>Edit Vehicle Permit Type</b></h5>
...
<div class="modal-body" style="overflow-y: scroll;">
	...
	<div class="form-body">
		...
		<div class="form-group">
			...
			{!! Form::label('name', 'Permit Type Name', array('class' => 'control-label col-md-4 required')) !!}
...
<script>
	...
	$('.validateform').validate({
		...
		rules: {
			...
			name: { 
				...
				remote: {
						...
						url: '{{ route('vehicle_permit_type_name') }}',
		...
		messages: {
			...
			name: { required: "Permit Type Name is required.", remote: "Permit Type Name is already exists!" },                
