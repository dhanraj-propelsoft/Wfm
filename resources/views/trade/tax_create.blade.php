<div class="modal-header" style="background-color: #e9ecef;">
	...
	<h5 class="modal-title float-right"><b>Add Tax</b></h5>
	...
	<div class="modal-body" style="overflow-y: scroll;">
		...
		<div class="row">
			...
			<div class="row">
				...
				{!! Form::checkbox('is_sales','1', null, ['id' => 'is_sales']) !!}
				...
				{!! Form::checkbox('is_purchase','1', null, ['id' => 'is_purchase']) !!}

					<label class="control-label" for="is_purchase"><span></span>Purchase Tax</label>
			...
			<div class="row">
				...
				<div class="form-group sales_ledgers" style="display: none;">
			...
			<div class="col-md-6 " >
				...
				<div class="form-group purchase_ledgers" style="display: none;">
