...
<div class="fill header">
  	<h4 class="float-left page-title">Discount</h4>
	...
	<div class="batch_container">
  	...
  	<table id="datatable" class="table data_table" width="100%" cellspacing="0">
        ...
        @foreach($discounts as $discount)
            <tr>
            	<td width="1">{{ Form::checkbox('discount',$discount->id, null, ['id' => $discount->id, 'class' => 'item_check']) }}<label for="{{$discount->id}}"><span></span></label></td>
                <td>{{ $discount->name }}</td>
