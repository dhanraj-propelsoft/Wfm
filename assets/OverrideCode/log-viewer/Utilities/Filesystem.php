...
class Filesystem implements FilesystemContract
{
    ...
    {
        $files = array_reverse($this->all());
        //$dates = $this->extractDates($files);
        //dd($dates);
        $fileNames = $this->extractFileName($files);
        //dd($fileNames);
        if ($withPaths) {
            $dates = array_combine($fileNames, $files); // [date => file]
        }
        //dd($dates);
        return $dates;
    }
    ...
    {
        //dd($date);
        //dd($this->storagePath.DS.$date.$this->extension);
        //$path = $this->storagePath.DS.$this->prefixPattern.$date.$this->extension;
        $path =$this->storagePath.DS.$date.$this->extension;
        //dd($path);
     ...
     * @return array
     */
    private function extractFileName(array $files)
    {
        return array_map(function ($file) {
            $info = pathinfo($file);
            //dd($info['filename']);
