		...
		<div class="tab-pane active" id="order_details">
	    	<div class="row" >
				...
				<div class="custom-panel" >
								...
								<input id="credit_type" type="radio"  disabled="disabled" name="job_sale_type"  value="credit" @if($transaction_type->name == "job_invoice" ) checked="checked" @endif  />
					...
					<div class="row" style="margin-left: 3px">
						...
						<div class=" search_container people " style= "width:21%;@if($customer_label == null) display:none @endif">
						...
						<div class=" search_container business" style= " width:21%;@if($customer_label == null) display:none @endif">
					...
					<div class="row">
		    			...
		    			<div class="col-md-3">
							<div class="form-group col-md-12">
								<div class="row">
								<label for="customer_group" class="customer_group require">Customer Group</label>
								{{ Form::text('customer_group', $vehicle_data->group_name, ['class' => 'form-control', 'id' => 'customer_group','disabled']) }}
								</div>
							</div>
						</div>	    			
		    		 	...
		    		 	<div class="col-md-12"style="">						
							...
							<tbody>
								...
								@foreach($taxes as $tax) 
									<option value="{{$tax->id}}" <?=($tax_groupid==$tax->id)?'selected':'';?>
									data-value="{{$tax->value}}" data-tax="{{$tax->tax_value}}" data-type="{{$tax->tax_type}}">{{$tax->display_name}}</option>
											@endforeach
								</select>
					...
					<div class="form-group custom-panel col-md-12" style="margin-top: 55px;">
							...
							<div class="col-md-12 ">
								<div class="row ">
									...
									<div class="col-md-3">
										...
										{{ Form::text('customer_name',$vehicle_data->customer, ['class'=>'form-control display_name', 'autocomplete' => 'off','id'=>'customer_name']) }} 
									</div>
									<div class="col-md-3">
										<label for="date">Mobile</label>
										{{ Form::text('customer_mobile', $vehicle_data->mobile_no, ['class'=>'form-control mobile', 'autocomplete' => 'off','id'=>'customer_mobile']) }} 
									</div>
									<div class="col-md-3">
										<label for="date">Email</label>
										{{ Form::text('customer_email', $vehicle_data->email_address, ['class'=>'form-control email', 'autocomplete' => 'off','id'=>'customer_email']) }} 
									</div>
									<div class="col-md-3">
										<label for="date">Address:</label>
											{{ Form::textarea('customer_address', $vehicle_data->address, ['class'=>'form-control address', 'style'=>' height: 30px;','id'=>'customer_address']) }} 
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-md-12 ">
								<div class="row ">
									...
									<div class="col-md-3  billing">
										...
										<input type="text" class="form-control  " name="billing_mobile"autocomplete="on"  />
									 </div>
									 <div class="col-md-3  billing">
