<div class="modal-header">
	<h4 class="modal-title float-right">Edit Vehicle Drivetrain</h4>
</div>

	{!!Form::model($drivetrain, [
...
<div class="modal-body">
	<div class="form-body">
		...
		<div class="form-group">
			{!! Form::label('name', 'Drivetrain Name', array('class' => 'control-label col-md-4 required')) !!}
	...
	$('.validateform').validate({
		...
		rules: {
			...
			name: { 
				required: true,
				remote: {
						url: '{{ route('vehicle_drivetrain_name') }}',
						type: "post",
						data: {
		...
		messages: {
			...
			name: { required: "Drivetrain Name is required.", remote: "Drivetrain Name is already exists!" },                
		},
