...
class CreateTaskFollowersTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection('mysql2')->create('task_followers', function($table){
        $table->increments('id');
        ...
        $table->foreign('follower_id')->references('id')->on('mysql.hrm_employees')->onUpdate('cascade')->onDelete('cascade');
    ...
    public function down()
    {
        ...
        Schema::connection('mysql2')->dropIfExists('task_followers');
    }
}
