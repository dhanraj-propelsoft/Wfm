<div class="modal-header">
    <h4 class="modal-title float-right">Edit Lead Status</h4>
</div>

        {!!Form::model($lead_status, ['class' => 'form-horizontal validateform'])!!}
        {{ csrf_field() }}
                 ...
                 data: {
                    ...
                    success:function(data, textStatus, jqXHR) {
                        ...
                        call_back(`<tr role="row" class="odd">
                            <td>
                                <input id="`+data.data.id+`" class="item_check" name="team" value="`+data.data.id+`" type="checkbox">
