<div class="modal-header">
	<h4 class="modal-title float-right">Edit Vehicle Tyre Size</h4>
</div>

	{!!Form::model($tyre_size, [
...
<div class="modal-body">
	<div class="form-body">
		...
		<div class="form-group">
			{!! Form::label('name', 'Tyre Size', array('class' => 'control-label col-md-4 required')) !!}
...
<script>
	$('.validateform').validate({
		...
		messages: {
			...
			name: { required: "Tyre Size is required.", remote: "Tyre Size is already exists!" },                
		},
