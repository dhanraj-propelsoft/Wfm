<div class="modal-header">
	<h4 class="modal-title float-right">Edit Vehicle Body Type</h4>
</div>

	{!!Form::model($body_type, [
...
<div class="modal-body">
	<div class="form-body">
		...
		<div class="form-group">
			{!! Form::label('name', 'Body Type Name', array('class' => 'control-label col-md-4 required')) !!}
