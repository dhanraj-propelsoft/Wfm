<div class="modal-header">
	<h4 class="modal-title float-right">Edit Holiday Type</h4>
</div>

	{!! Form::model($holiday_types,['class' => 'form-horizontal validateform']) !!}
	{{ csrf_field() }}
...
<div class="modal-body">
	<div class="form-body">
		...
		<div class="form-group">
			{!! Form::label('name', 'Holiyday Type', array('class' => 'control-label col-md-4 required')) !!}
			<div class="col-md-12">
		...
		<div class="form-group">
			...
			<div class="col-md-12">
			{!! Form::radio('pay_status', '0', true, ['id' => 'paid']) !!}
			<label for="paid" class = 'control-label col-md-3'><span></span>Paid</label>

			{!! Form::radio('pay_status', '1','', ['id' => 'unpaid']) !!}
...
$(document).ready(function()
{
	...
	$('.validateform').validate({
		...
		submitHandler: function(form) {
			...
			$.ajax({
			url: '{{ route('holiday_types.update') }}',
			type: 'post',
			data: {
				_token: '{{ csrf_token() }}',
				_method:'PATCH',
