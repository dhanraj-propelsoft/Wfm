...
class CreateTaskCreatorsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::connection('mysql2')->create('task_creators', function($table){
        ...
        $table->foreign('creator_id')->references('id')->on('mysql.hrm_employees')->onUpdate('cascade')->onDelete('cascade');
    ...
    public function down()
    {
        ...
        Schema::connection('mysql2')->dropIfExists('task_creators');
    }
}
