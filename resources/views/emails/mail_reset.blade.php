                    ...
                    <tr>
                      <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
                       <center><img src="{{ $message->embed(public_path().'/logo.png') }}" width="198" ></center> 
                        ...
                        <h3>Hi {{$name}},</h3>
                        <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px; color: #4d4d4f;">Your OTP code is <b>{{$otp}}</b>. Use this code to access your account.</p>

                        <p style="font-family:sans-serif;font-size:14px;font-weight:normal;margin:0;Margin-bottom:15px; color: #4d4d4f;">After you logged in change your password.</p>
