		...
		<div class="form-body">
		  	<div class="row">
		  		<div class="col-md-3 customer_type" > 
					{{ Form::label('customer_name', 'User type', array('class' => 'control-label required')) }}<br>
					<div class="custom-panel">
						<input id="business_types" type="radio" name="customer_name_type" checked="checked" value="1" />
						<label for="business_types" class="custom-panel-radio"><span></span>Business</label>
						<input id="people_types" type="radio" name="customer_name_type"  value="0" />
						<label for="people_types" ><span></span>People</label>
			...
			<div class="col-md-2">
			  	<div class="form-group"> 
					...
					{!! Form::text('mobile_no', null, ['class' => 'form-control numbers','id' => 'mobile_no','style' => 'background-color: yellow;']) !!} 
				</div>
			</div>
			<div class="col-md-1">
			  	<div class="form-group"> 
					...
					{!! Form::select('title',$title, null, ['class' => 'select1 form-control' ,'id'=> 'state' ]) !!} 
				</div>
			</div>
			<div class="col-md-4">
			  	<div class="form-group"> 
				  	{!! Form::label('business_name', 'First/Business Name', ['class' => 'control-label required']) !!}
					
					{!! Form::text('business_name', null, ['class' => 'form-control ','id' => 'business_name','style' => 'background-color: yellow;']) !!}
				</div>
			</div>
				...
				<div class="col-md-6">
		  		...
		  		<div class="col-md-6">
				  	<div class="form-group"> 
						...
						{!! Form::select('group_name',$group_name, null, ['class' => 'select_item form-control' ,'id'=> 'group_name' ]) !!}  
					</div>
				</div>
		  		<div class="col-md-6">
			  		<div class="form-group"> 
				...
				<div class="tab-pane active" id="address">
				  <div class="row">
					...
					<div class="col-md-6 shipping_address"> {!! Form::label('shipping_address', 'Shipping Address', ['class' => 'control-label']) !!}
					  ...
					  <div class="row">
						<div class="col-md-6">
						  <div class="form-group"> {!! Form::select('shipping_state_id',$state, null, ['class' => 'select_item form-control' ,'id'=> 'state' , 'disabled']) !!} </div>
						</div>
						<div class="col-md-6">
...
Dropzone.autoDiscover = false;
		...
		var business_file_upload = new Dropzone("div#business_file-upload", {
		 ...
		 $('input[name=business_name]').keyup(function(){
		  ...
		  $('input[name=last_name]').keyup(function(){
			var value = $(this).val();
			var first_name = $('#business_name').val();
	...
	$('input[name=mobile_no]').blur(function(){
		...
		var data = $(this).val();
		var user_type = $('input[name=customer_name_type]:checked').val();
			   ...
			   $('.loader_wall_onspot').show();
				$.ajax({
				 ...
				 data: {
				  ...
				  email_address: $('.add_business_modal input[name=email_address]').val(),
				  ...
				  same_billing_address: $('.add_business_modal input[name=same_billing_address]').val(),
