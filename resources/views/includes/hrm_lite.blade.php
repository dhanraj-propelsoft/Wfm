...
@if($plan_name=='Lite')
	...
	<li class="header"><span>Hrm</span></li>
	  	...
	  	<li>
	  		<a class="sub-menu"><i class="fa icon-basic-folder-multiple"></i><span>Masters</span></a>
	  	...
	  	<!-- <li>
	  		<a class="sub-menu"><i class="fa icon-basic-folder-multiple"></i><span>Attendance</span></a>
	  	...
	  	<!-- <li>
	  		<a class="sub-menu"><i class="fa icon-basic-folder-multiple"></i><span>Recruit</span></a>
			<div class="sidebar-submenu">
				<ul>
