...
class CreateTransactionItemsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('transaction_items', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('parent_item_id', false)->unsigned()->nullable();
            $table->integer('transaction_id', false)->unsigned();
            $table->integer('item_id', false)->unsigned();   
            $table->time('start_time')->nullable();   
            $table->time('end_time')->nullable();
            $table->integer('assigned_employee_id', false)->unsigned()->nullable();
            $table->integer('job_item_status', false)->unsigned()->nullable();
            ...
            $table->foreign('item_id')->references('id')->on('inventory_items')->onUpdate('cascade')->onDelete('cascade');
             ...
             $table->foreign('assigned_employee_id')->references('id')->on('hrm_employees')
