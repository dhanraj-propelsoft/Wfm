...
class CreateTransactionRecurringsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transaction_recurrings', function (Blueprint $table) {
            ...
            $table->integer('end_occurrence', false)->nullable();
            ...
            $table->foreign('id')->references('id')->onUpdate('cascade')->on('transactions')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('transaction_recurrings');
    }
}
