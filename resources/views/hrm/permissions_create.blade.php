<div class="modal-header">
    <h4 class="modal-title float-right">Add Permission Request</h4>
</div>
	...
	<div class="modal-body">
		<div class="form-body">
			...
			<div class="form-group">
				...
				<div class="col-md-12">
					{!! Form::text('permission_date', null,['class' => 'form-control accounts-date-picker']) !!}
				</div>
			</div>
			...
			<div class="form-group">
				{!! Form::label('from_time', 'From Time', array('class' => 'control-label col-md-4 required')) !!}
			...
			<div class="form-group">						 
				{!! Form::label('to_time', 'To Time', ['class' => 'control-label col-md-3 required']) !!}
                ...
                call_back(`<tr role="row" class="odd">
                    ...
                    <td>
						...
						<select style="display:none" id="`+data.data.id+`" class="approval_status form-control">
							...
							<option `+pending_approve_selected+` value="0">Pending</option>
						</select>
					</td>
