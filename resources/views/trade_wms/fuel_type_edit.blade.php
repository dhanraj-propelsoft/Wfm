<div class="modal-header">
	<h4 class="modal-title float-right">Edit Vehicle Fuel Type</h4>
</div>

	{!!Form::model($fuel_type, [
...
<div class="modal-body">
	<div class="form-body">
		...
		<div class="form-group">
			{!! Form::label('name', 'Fuel Type Name', array('class' => 'control-label col-md-4 required')) !!}
	...
	$('.validateform').validate({
		...
		rules: {
			...
			name: { 
				required: true,
				remote: {
						url: '{{ route('vehicle_fuel_type_name') }}',
						type: "post",
						data: {
		...
		messages: {
			...
			name: { required: "Fuel Type Name is required.", remote: "Fuel Type Name is already exists!" },                
		},
