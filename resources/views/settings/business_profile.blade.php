...
<div class="fill header">
  <h4 class="float-left page-title">Business Profile</h4>
	 ...
	 @foreach($businesses as $business)
		<tr>
			...
			@endpermission
		  	...
		  	<td>			
				<a href="{{route('business_profile.show', $business->id)}}" data-id="{{$business->id}}" class="grid_label action-btn show-icon show"><i class="fa li_eye"></i>			
		  	</td>
		</tr>
	 @endforeach
	</tbody>
