...
<div class="fill header">
  	<h4 class="float-left page-title">Vehicles</h4>
</div>
...
<div class="col-md-3 search_container vehicle"> {{ Form::label('vehicle', 'Vehicle', array('class' => 'control-label required')) }}
			{{ Form::select('vehicle_id', $vehicle, null, ['class' => 'form-control vehicle_id', 'id' => 'vehicle_id']) }}
