		...
		<div class="form-body">
			...
			<div class="col-md-12" >
				<div class="form-group" >
                    ...
                    <span class="fa fa-plus-circle floating-label" style="color: #999;"">&nbsp;Task To Do <i>(task)</i></span>
				</div>
      ...
      <select id="project_type" type="select" class="form-control tooltips" title="Under The Project" name="project_type" style="color: #919191;">
    ...
    <option>Project 3</option>
      ...
      <input id="Deadline" type="" class="form-control date-picker tooltips" title="Deadline" name="Deadline" placeholder="Deadline" style="color: #919191;" data-date-format = 'dd-mm-yyyy'>
    </div>
		   </div>
 </div>
 <div class="row">
     ...
     <select id="create_by" type="select" class="form-control tooltips" title="Created By" name="project" placeholder="Select Project" style="color: #919191;">
    ...
    <select id="assign_to" type="select" class="form-control tooltips" title="Assign To" name="assign_to" placeholder="assign_to" style="color: #919191;">
 ...
 <div class="row">
    ...
    <input id="start_date"  class="form-control date-picker tooltips" title="Start Date" name="start_date"  placeholder="Start Date" style="color: #919191;" data-date-format = 'dd-mm-yyyy'>
    ...
    <input id="Due date"  placeholder="Due Date" class="form-control to-date-picker tooltips" title="Due Date" name="due_date" style="color: #919191;" data-date-format = 'dd-mm-yyyy'>
    </div>
		   </div>
 </div>
 ...
 <div class="row">
    ...
    <select id="size" type="select" class="form-control tooltips" title="Size" name="size"  style="color: #919191;">
    ...
    <input id="worth" type="text" class="form-control tooltips " title="Worth" name="worth" placeholder="Worth" style="color: #919191;">
    </div>
		   </div>
 </div>
  ...
  <div class="row">
      ...
      <div class="input_icon_fixed pull-left " style="width:100%" >
                ...
                <p class="pull-left" style="margin: 3% 0 0 27%;" >&nbsp;{!! Form::radio('Priority', 'false', null,['style'=>"display:initial;"]) !!}</p>   
                    <span class="pull-left" style="margin: 0 0 0 1%"><?php echo priority_high(); ?></span>
                <p class="pull-left" style="margin: 3% 0 0 5%;" >&nbsp;{!! Form::radio('Priority', 'false', null,['style'=>"display:initial;"]) !!}</p>
                <span class="pull-left" style="margin: 0 0 0 1%;"><?php echo priority_medium(); ?></span>
                <p class="pull-left" style="margin: 3% 0 0 5%;" >&nbsp;{!! Form::radio('Priority', 'false', null,['style'=>"display:initial;"]) !!}</p>
                <span class="pull-left" style="margin: 0 0 0 1%;"><?php echo priority_normal(); ?></span>
                <p class="pull-left" style="margin: 3% 0 0 5%;" >&nbsp;{!! Form::radio('Priority', 'false', null,['style'=>"display:initial;"]) !!}</p>
                <span class="pull-left" style="margin: 0 0 0 1%;"><?php echo priority_low(); ?></span>
           ...
           <p style="margin-top:6px"> No of days:&nbsp;</p>
            <div class="btn_round days pull-left calculate ">
            </div>
        </div>
    </div>
		   </div>
...
// alert($(this).val());
         ...
         if($(this).val()!="")
           {
           /*$(".calculate").text(	calculate($("input[name=start_date]").datepicker('getDate'),$("input[name=due_date]").datepicker('getDate'))  );*/
...
$(document).ready(function () {
    ...
    // sample taken from http://aehlke.github.io/tag-it/
