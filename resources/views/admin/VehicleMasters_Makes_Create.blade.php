<div class="modal-header">
	<h4 class="modal-title float-right">Add   Make</h4>
</div>
...
<div class="modal-body">
	<div class="form-body">
			...
			{!! Form::label('make', 'Add make ', array('class' => 'control-label  required','id'=>'make')) !!}
...
<script>
	...
	$('.validateform').validate({
        ...
        return {
        	url: '{{ route('vehicle_makenamecheck') }}',
		 			type: "post",
            data: {
