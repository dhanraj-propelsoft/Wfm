					...
					<div class="form-group col-md-12" style="float:left;">
						<div class="row">
							<div class="col-md-12 show_complaint" style="display:none;">					
								...
								<textarea name="complaints" class="form-control job_complaint" style="width:40%;" disabled></textarea></br>
								<!-- {{ Form::textarea('compliants',"<ol><li></li></ol>", ['class'=>'form-control order', 'size' => '30x2','id' => 'editor']) }} -->
							</div>
						</div>
					</div>
						...
						<div class="form-group">
							<table style="border-collapse: collapse;" class="table table-bordered crud_table">
								...
								<tr>
									...
									@endif
									<th width="12%">Description</th>
									<th width="6%">In Stock</th>
									<th width="6%">Qty</th>
									<th width="10%">Unit Price</th>
									<th width="10%">Amount</th>					
									<th width="10%" style= "@if($transaction_type->name == 'job_card') display:none @endif">Tax</th>
									@if($discount_option)
										<th width="13%" style= "@if($transaction_type->name == 'job_card') display:none @endif">Disc.Type</th>
										<th width="8%" style= "@if($transaction_type->name == 'job_card') display:none @endif">Discount</th>
									@endif
								...
								<tr class="parent items">
									...
									<td style= "@if($transaction_type->name == 'job_card') display:none @endif">
										<select name='tax_id' class='form-control select_item taxes' id = 'tax_id' disabled>
											<option value="">Select Tax</option>
												@foreach($taxes as $tax) 
									...
									@if($transaction_type->name == "job_card")
										<td>
											...
											<div class='start_time_container'></div>
									...
									@if($transaction_type->name == "job_card")
										<td>
											...
											<div class='end_time_container'></div>
										</td>
									@endif
									...
									@if($transaction_type->name == "job_card")
										<td>
											...
											<div class='item_status_container'></div>
										</td>
									@endif
						...
						<div style="padding: 10px 0;" class="form-group">
							...
							<div style="float:right; border:1px solid #ccc; padding: 5px;">
								<table class= "total_rows" style="float:right;" cellpadding="5em">
									...
									<tr class="credit_limit" style="display: none;">
									<td><h6 style="float:right; text-align:right; font-weight:bold;">Credit Limit</h6></td>
									<td></td>
									<td>
										<h6 class="credit_limit_value" style="float:right; text-align:right; width: 150px;">0.00</h6>
										{{ Form::hidden('credit_limit_text', null, ['class'=>'form-control decimal']) }}</td>
									</tr>
									@endif
