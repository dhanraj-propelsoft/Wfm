<div class="modal-header">
	<h4 class="modal-title float-right">Edit Vehicle Service Type</h4>
</div>

	{!!Form::model($service_type, [				
...
<div class="modal-body">
	<div class="form-body">
		...
		<div class="form-group">
			{!! Form::label('name', 'Service Type Name', array('class' => 'control-label col-md-4 required')) !!}
...
<script>
	$('.validateform').validate({
		...
		messages: {
			...
			name: { required: "Service Type Name is required.", remote: "Service Type Name is already exists!" },                
		},
